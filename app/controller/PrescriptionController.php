...
class PrescriptionController extends BaseController
{
    ...
    public function detail(Request $request)
    {
        ...
        try {
            $prescription = Prescription::with('user')->find($id);
            ...
            return json([
                ...
                'data' => [
                    ...
                    'prescription_image' => $prescription->image_url,
     ...
     * 提取处方信息
     */
    private function extractPrescriptionInfo(Prescription $prescription)
    {
        try {
            // 调用ThinkAI服务
            ...
            // 更新状态为失败
            $prescription->save([
                'status' => Prescription::STATUS_FAILED,
